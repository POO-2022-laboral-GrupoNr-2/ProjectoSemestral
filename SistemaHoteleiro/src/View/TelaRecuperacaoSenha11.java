...
public class TelaRecuperacaoSenha11 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblCodigoID.setText("Código do Funcionario");
    ...
    private void btnAlterarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAlterarMousePressed
        ...
        String novaSenha = txtSenhaNova.getText().trim();
        String confirmar = txtConfirmarSenha.getText().trim();
        if (novaSenha.equalsIgnoreCase(confirmar) && !novaSenha.isEmpty() && !confirmar.isEmpty()) {
            Long id = Long.parseLong(txtCodigoID.getText().trim());
            FuncionarioController.recuperarSenha(id, novaSenha);
            JOptionPane.showMessageDialog(null, "Efectuado com sucesso!");
            this.limparCampos();
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaRecuperacaoSenha11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
